...
import { Icons8Edit, Icons8Trash } from "@/components/shared/icons/Icons8";
...
export function SampleTable({ data, isLoading, onEdit, onDelete }: SampleTableProps) {
    ...
    const columns = [
        ...
        columnHelper.accessor("createdAt", {
            header: "วันที่สร้าง",
            cell: (info) => (
                <span className="text-slate-600">{formatDateTime(info.getValue())}</span>
            ),
        }),
    ...
    return (
        <div className="overflow-hidden rounded-2xl bg-white/70 shadow-sm backdrop-blur-xl">
            <div className="overflow-x-auto">
                <table className="w-full text-sm" role="table" aria-label="ตารางข้อมูลตัวอย่าง">
                    <thead>
